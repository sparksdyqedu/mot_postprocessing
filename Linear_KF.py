...
class KalmanFilter:
    ...
    def __init__(self, SystemModel):
        self.F = SystemModel.F.float();
        self.F_T = torch.transpose(self.F, 0, 1);
        self.m = SystemModel.m

        self.Q = SystemModel.Q.float();

        self.H = SystemModel.H.float();
        self.H_T = torch.transpose(self.H, 0, 1);
        self.n = SystemModel.n

        self.R = SystemModel.R.float();
    ...
    def GenerateSequence(self, y, T):
        ...
        self.m1x_0[0][0] = y[:, 0][0]
        self.m1x_0[1][0] = y[:, 0][1]
        self.m1x_0[2][0] = y[:, 0][2]
        self.m1x_0[3][0] = y[:, 0][3]
